...
export default function MilestoneProgressBar({ progress }: MilestoneProgressBarProps) {
  const radius = 60;
    ...
    <div className="rounded-lg border bg-card p-6">
      <div className="flex items-center justify-between">
        <div className="flex-1">
          <h3 className="text-lg font-semibold mb-1">Milestone Progress</h3>
          <p className="text-sm text-muted-foreground mb-4">
            Track your milestone completion status
          </p>
